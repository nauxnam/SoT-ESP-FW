...
logging.basicConfig(filename='ESPlog.log', level=logging.DEBUG,
...
def initialize_window():
    ...
    """
    b_label = Label(b64decode('U09URVNQW2ZyYW1ld29ya10gdmVyOjEuNS4wYQ==').decode("utf-8"),
                    x=SOT_WINDOW_W - 537, y=10, font_size=12,
